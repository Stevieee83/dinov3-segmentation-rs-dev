...
parser.add_argument("--image_dir", type=str,
                    default="C:/Users/r02sw23/PycharmProjects/pythonProject2/dinov3-dora-classifier-segmentation-tests/test/images/")
parser.add_argument("--label_dir", type=str,
                    default="C:/Users/r02sw23/PycharmProjects/pythonProject2/dinov3-dora-classifier-segmentation-tests/test/masks/")
...
parser.add_argument("--filename", type=str,
                    default="C:/Users/r02sw23/PycharmProjects/pythonProject2/dinov3-foreground-segmentation-tests-natural/fg_classifier.pkl")
...
def main():
    ...
    wandb.init(project=f"DINOv3 Natural {args.model_type} ForeGround Segmentation Tests",
               name=f"Borebreen Images 1 to {int(args.total_imgs/4)}")
    ...
    model = torch.hub.load(
        ...
        weights='C:/model_weights/dinov3/dinov3_vitl16_pretrain_sat493m-eadcf0ff.pth',
    )

...
parser.add_argument("--test_image_path", type=str, default="/uoa/scratch/users/r02sw23/borebreen-drone-image-data-test/images/borebreen_crop_drone_1.png")
...
def main():
    ...
    wandb.init(project=f"DINOv3 Natural {args.model_type} ForeGround Segmentation Tests Maxwell",
               name=f"Feature Extraction {args.image_size}")

...
parser.add_argument("--images_no", type=int, default=22)
parser.add_argument("--image_dir", type=str, default="/uoa/scratch/users/r02sw23/borebreen-drone-image-data-test/images")
parser.add_argument("--labels_dir", type=str, default="/uoa/scratch/users/r02sw23/borebreen-drone-image-data-test/masks")
parser.add_argument("--output_csv", type=str, default="/uoa/scratch/users/r02sw23/dinov3-main-fedr/output_csv_images/768_test/")
# ------------------------------------------------------------------------
...
def main():
    ...
    wandb.init(project=f"DINOv3 Segmentation FE to CSV {args.model_type} Images 768 Test",
    ...
    model = torch.hub.load(
        ...
        weights='/uoa/scratch/users/r02sw23/dinov3-main/pre_trained_weights/dinov3_vit7b16_pretrain_sat493m-a6675841.pth',
    )

...
parser.add_argument("--output_csv", type=str, default="/uoa/scratch/users/r02sw23/dinov3-main-fedr/output_csv_rs/")
# ------------------------------------------------------------------------
...
def main():
    ...
    wandb.init(project=f"DINOv3 Segmentation FE to CSV {args.model_type}RS",

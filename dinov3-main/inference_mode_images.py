...
parser.add_argument("--output_path", type=str, default="/uoa/scratch/users/r02sw23/dinov3-main/saved_models/8_RF/")
...
parser.add_argument("--filename", type=str, default="/uoa/scratch/users/r02sw23/dinov3-main/saved_models_rf/fg_classifier100_est.pkl")
# ------------------------------------------------------------------------
